...
Refactor
 */
public class MathAndComputerScience extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_and_computer_science);

        calculus = findViewById(R.id.calculusM1);
        ...
        algebra = findViewById(R.id.algebraM1);
        ...
        geometry = findViewById(R.id.geometryM1);
